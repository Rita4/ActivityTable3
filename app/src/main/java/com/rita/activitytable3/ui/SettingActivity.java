...
import com.rita.activitytable3.bean.RandomProject;
import com.rita.activitytable3.bean.Project;
import android.widget.TextView;
import com.kymjs.rxvolley.client.HttpCallback;

import com.rita.activitytable3.ui.AboutActivity;
import com.rita.activitytable3.AppContext;
import com.rita.activitytable3.common.FileUtils;
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		GitOSCApi.getRandomProject(new HttpCallback() {
			...
			public void onSuccess(Map<String, String> headers, byte[] t) {
				...
				RandomProject mProject = JsonUtils.toBean(RandomProject.class, t);
				if (mProject != null && mProject.getRand_num() == 0) {
					//mProjectTitle.setText(mProject.getOwner().getName() + "/" + mProject.getName());
					//TextView t_title =(TextView)findViewById(R.id.set_test_http);
					t_title.setText(mProject.getOwner().getName() + " / " + mProject.getName());
				}
			}
			@Override
