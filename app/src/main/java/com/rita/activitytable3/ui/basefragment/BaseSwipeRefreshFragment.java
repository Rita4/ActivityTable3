...
import com.rita.activitytable3.bean.Entity;
import com.rita.activitytable3.bean.MessageData;
...
public abstract class BaseSwipeRefreshFragment<T extends Entity>
	...
	//{ self defined, mainly for change view
	...
	// Rita: for child class, get http data
    public abstract void requestData();
    public abstract void onItemClick(int position, T data);

	//{ for HttpCallback mHandler
